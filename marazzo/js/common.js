jQuery(document).ready(function() {
    ...
    jQuery("#nav li.level0.drop-sitemenu").mouseover(function() {
            return jQuery(window).width() >= 740 && jQuery(this).children("ul.level1").fadeIn(100), !1
        }).mouseleave(function() {
            return jQuery(window).width() >= 740 && jQuery(this).children("ul.level1").fadeOut(100), !1
        }), jQuery("#nav li.level0.drop-sitemenu li").mouseover(function() {
    ...
    jQuery("#category-desc-slider .slider-items").owlCarousel({
       ...
       jQuery("#gallery_01 .slider-items").owlCarousel({
		...
		/* Mobile Menu */	
        jQuery("#mobile-sitemenu").mobileMenu({
            MenuWidth: 250,
            SlideSpeed: 300,
            WindowsMaxWidth: 767,
            PagePush: !0,
...
jQuery(window).on("load", function() {
        isTouchDevice && jQuery("#nav a.level-top").on("click", function() {
            if ($t = jQuery(this), $parent = $t.parent(), $parent.hasClass("parent")) {
                if (!$t.hasClass("sitemenu-ready")) return jQuery("#nav a.level-top").removeClass("sitemenu-ready"), $t.addClass("sitemenu-ready"), !1;
                $t.removeClass("sitemenu-ready")
            }
        }), jQuery().UItoTop()
    }),
    /*  ToTop */
